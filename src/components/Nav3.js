         ...
         <div className='flex items-center flex-1'> 
          ...
          <div>
            <ul className='flex gap-8 mr-16 text-[18px]'>
              <Link><li className='hover:text-sky-600 transition border border-b-2  border-white hover:border-sky-600 cursor-pointer'>About us</li></Link>
              {/* mega nav start */}
              <div className='group'>
                <button className='hover:text-sky-600 pt-0.5 mt-0.5 over:text-sky-600 transition border border-b-2 border-white  hover:border-sky-600 cursor-pointer'>
                  Services
                </button>
                <div className='hidden group-hover:flex flex-col absolute left-0 top-20  p-10 w-full bg-white z-20 text-black duration-300'>
                <div className='grid  grid-cols-2 md:grid-cols-4 gap-5 pl-96 ml-96 '>
                   <div className='flex flex-col'>
                    <h3 className='mb-4 text-2xl text-sky-600'>
                      abc
                    </h3>
                    <Link className='hover:underline hover:text-orange-500'>efg</Link>
                    <Link className='hover:underline hover:text-orange-500'>efg</Link>  
                    <Link className='hover:underline hover:text-orange-500'>efg</Link>
                    <Link className='hover:underline hover:text-orange-500'>efg</Link>
                   </div>
              ...
              {/* mega nav end */}
              <Link><li className='hover:text-sky-600 transition border border-b-2 border-white  hover:border-sky-600 cursor-pointer'>Careers</li></Link>
              <Link><li className='hover:text-sky-600 transition border border-b-2 border-white  hover:border-sky-600 cursor-pointer'>Events</li></Link>
              <Link><li className='hover:text-sky-600 transition border border-b-2 border-white  hover:border-sky-600 cursor-pointer'>Blogs</li></Link>
              <Link><li className='hover:text-sky-600 transition border border-b-2 border-white  hover:border-sky-600 cursor-pointer'>Contact Us</li></Link>
               </ul>
          </div>
         </div>
     </nav>
