...
import img1  from "C:/Users/krish/OneDrive/Desktop/sms2 - Copy/smsloud/src/assets/voice.jpeg"
  ...
  return (
    <div>
            <div className="lg:w-[50%] md:w-[70%]  lg:top-[30%] mr-10 lg:left-[30%]  z-10 absolute border border-black">
                    ...
                    Voice Messaging
            <span id="close" className=" text-red-600 rounded-md float-end bg-sky-200 hover:cursor-pointer p-1" onClick={() => handleClose()}><AiOutlineClose/></span>
                    </h1>
                        ...
                        <div className="flex p-5 gap-3 ">
                          <div className="">
                            <div className="flex">
                              ...
                              A voice message is a type of message that you can send or receive using your voice.
                 </h1>
                            </div>
